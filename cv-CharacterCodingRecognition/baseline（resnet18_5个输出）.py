# -*- coding: utf-8 -*-
"""Baselinev1（resnet18 5个输出）.ipynb
...
"""# 预测并生成提交文件"""
test_path = glob.glob('./dataset/mchar_test_a/*.png')
test_path.sort()
# test_json = json.load(open('./dataset/mchar_test_a.json'))
...
df_submit.to_csv('./dataset/submit.csv', index=None)
